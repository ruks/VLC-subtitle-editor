...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Fri Sep 6 22:24:40 2013
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -Inbproject -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -Inbproject -Inbproject -Inbproject -Inbproject -Inbproject -Inbproject -Inbproject -Inbproject -Inbproject -Inbproject -I. -I. -I.
LINK          = g++
LFLAGS        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/waveViewer1.0.0/ && $(COPY_FILE) --parents Observable.h subtitleEditor.h IObserver.h MainWindow.h player.h smem.h srtFormat.h header/tgs.h header/MyGraphicScene.h printbits.h subtitleSave.h header/SubtitleRead.h build/Debug/GNU-Linux-x86/waveViewer1.0.0/ && $(COPY_FILE) --parents smem.cpp printbits.cpp main.cpp subtitleSave.cpp subtitleEditor.cpp source/MyGraphicScene.cpp source/SubtitleRead.cpp MainWindow.cpp source/tgs.cpp player.cpp Observable.cpp build/Debug/GNU-Linux-x86/waveViewer1.0.0/ && $(COPY_FILE) --parents MainWindow.ui build/Debug/GNU-Linux-x86/waveViewer1.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/waveViewer1.0.0` && $(TAR) waveViewer1.0.0.tar waveViewer1.0.0 && $(COMPRESS) waveViewer1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/waveViewer1.0.0`/waveViewer1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/waveViewer1.0.0
