...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Tue Sep 10 21:30:01 2013
...
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu -lvlc /home/rukshan/NetBeansProjects/waveViewer/lib/libsoundfile.a -lsndfile -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
OBJECTS       = build/Debug/GNU-Linux-x86/smem.o \
		...
		build/Debug/GNU-Linux-x86/MyGraphicScene.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/waveViewer1.0.0/ && $(COPY_FILE) --parents Observable.h subtitleEditor.h IObserver.h MainWindow.h FileSelector.h player.h smem.h srtFormat.h header/tgs.h header/MyGraphicScene.h printbits.h subtitleSave.h header/SubtitleRead.h build/Debug/GNU-Linux-x86/waveViewer1.0.0/ && $(COPY_FILE) --parents smem.cpp printbits.cpp FileSelector.cpp main.cpp subtitleSave.cpp subtitleEditor.cpp source/MyGraphicScene.cpp source/SubtitleRead.cpp MainWindow.cpp source/tgs.cpp player.cpp Observable.cpp build/Debug/GNU-Linux-x86/waveViewer1.0.0/ && $(COPY_FILE) --parents FileSelector.ui MainWindow.ui build/Debug/GNU-Linux-x86/waveViewer1.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/waveViewer1.0.0` && $(TAR) waveViewer1.0.0.tar waveViewer1.0.0 && $(COMPRESS) waveViewer1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/waveViewer1.0.0`/waveViewer1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/waveViewer1.0.0
...
build/Debug/GNU-Linux-x86/MyGraphicScene.o: source/MyGraphicScene.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/MyGraphicScene.o source/MyGraphicScene.cpp
