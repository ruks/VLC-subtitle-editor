...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Sep 18 08:27:13 2013
...
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu -lvlc /home/rukshan/NetBeansProjects/waveViewer/lib/libsoundfile.a -lsndfile -lcppunit -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/waveViewer1.0.0/ && $(COPY_FILE) --parents Observable.h subtitleEditor.h IObserver.h MainWindow.h FileSelector.h player.h qcustomplot.h srtFormat.h header/tgs.h printbits.h subtitleSave.h header/SubtitleRead.h build/Debug/GNU-Linux-x86/waveViewer1.0.0/ && $(COPY_FILE) --parents printbits.cpp FileSelector.cpp main.cpp subtitleSave.cpp subtitleEditor.cpp source/SubtitleRead.cpp MainWindow.cpp source/tgs.cpp player.cpp Observable.cpp qcustomplot.cpp build/Debug/GNU-Linux-x86/waveViewer1.0.0/ && $(COPY_FILE) --parents FileSelector.ui MainWindow.ui build/Debug/GNU-Linux-x86/waveViewer1.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/waveViewer1.0.0` && $(TAR) waveViewer1.0.0.tar waveViewer1.0.0 && $(COMPRESS) waveViewer1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/waveViewer1.0.0`/waveViewer1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/waveViewer1.0.0
